                        ...
                        <div class="card-body text-center">
                            <div class="table-responsive mb-4">
                                <table class="table">
									...
									<tr>
                                        <th class="text-center p-2 align-middle" width=50>분실물 사진</th>
                                        <td class="lh-lg text-center p-2" align=center>
                                            <img src="../kk/<%= java.net.URLEncoder.encode(sfile, "euc-kr") %> " width=600>
                                        </td>
                                    </tr>
